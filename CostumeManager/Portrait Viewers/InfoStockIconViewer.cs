...
namespace BrawlCostumeManager
{
    ...
    public class InfoStockIconViewer : PortraitViewer
    {
        ...
        private static PortraitViewerTextureData[] textureData = { new PortraitViewerTextureData(32, 32, (i, j) => "Misc Data [30]/Textures(NW4R)/InfStc." + (i * 50 + (j <= 12 ? j + 1 : j)).ToString("D4")) };
